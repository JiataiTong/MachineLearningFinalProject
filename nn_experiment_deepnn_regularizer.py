...
res_filename = f'result/result_nn_deep_reg_6_iter_{current_time}.csv'
    ...
    for dataset_size in dataset_size_list:
        ...
        for depth in depths:
            for layer_size in layer_sizes:
                ...
                best_param, best_f1 = find_best_hyperparameters_regularization(Network, in_size, layer_dims, train_dataset_binary, val_dataset_binary, param_grid)
                ...
                model.train_model_binary_regularization(
                    ...
                    reg_class=best_param["regularization_class"],
                    reg_lambda=best_param["regularization_lambda"]
                )
