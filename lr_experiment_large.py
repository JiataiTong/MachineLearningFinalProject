...
res_filename = f"result/result_logistic_large_{current_time}.csv"
pd.DataFrame(
    columns=[
        "dataset_size",
        "num_epochs",
...
for dataset_size in dataset_size_list:
    train_df, scaler = pre_process_training_dataset(f"experiment_data/training_{dataset_size}.csv")
    val_df = pre_process_test_dataset(f"experiment_data/validating_{dataset_size}.csv", scaler)
    test_df = pre_process_test_dataset(f"experiment_data/testing_{test_data_size}.csv", scaler)
